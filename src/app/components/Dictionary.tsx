const Dictionary = () => {
  return (
    <div className="py-8 max-w-2xl lg:mx-0 lg:flex-auto">
      ...
      <h1 className="max-w-lg text-5xl font-bold tracking-tight text-black sm:text-6xl font-serif">
        Vue·​ware
      ...
      <div className="mt-2 border-l border-primary pl-8">
        <blockquote className="text-lg leading-8 text-black/75">
          <p>
            ...
            software. Vueware provides companies with software that delivers
            deep insights, enabling them to focus on their core strengths and
            excel in what they do best. As a no-nonsense company, we are
            straightforward and honor our commitments.”
          </p>
        </blockquote>
      </div>
    </div>
